...
function [taskStruct, dispStruct] = initTask_training()
...
% Output folder
taskStruct.outputFolder = fullfile('..', 'patientData','trainingLogs');
...
taskStruct.nBlocks = 1; %4
taskStruct.nTrialsPerBlock = 16; % 48
...
[X,Y] = meshgrid(taskStruct.trialCategories,taskStruct.trialAxis);
result = [X(:) Y(:)];
n = size(result,1);
...
taskStruct.stimFolder = fullfile('..', 'stimuli','Training_Stim');
