...
# echo $debug
python3 -c 'from multinomial_decoding import decode_multiclass; decode_multiclass.decode_withintask_permutationtest('${debug}', '${n_threads}', '${n_iter}', '${rndseed}', '${newsubs}')'